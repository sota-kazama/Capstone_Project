...
<div class="container py-5">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <h1 class="mb-4 text-center"><?= $is_view_mode ? '目標の振り返り' : '成果を記録する' ?></h1>
            ...
            <form action="results_post.php" method="POST">
                ...
                <div class="card shadow-sm mb-4 border-primary">
                    ...
                    <div class="card-body">
                        ...
                        <?php else: ?>
                            <p class="text-muted">目標が見つかりませんでした。</p>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="card shadow-sm mb-4">
                    <div class="card-header fw-bold">
                        目標の最終結果 
                        <?php if (!$is_view_mode): ?>
                            <span class="badge <?= $is_past_deadline ? 'bg-danger' : 'bg-secondary' ?> ms-2">
                                <?= $is_past_deadline ? '入力必須' : '任意' ?>
                            </span>
                        <?php endif; ?>
                    </div>
                ...
                <div class="d-grid gap-2 mb-5">
                    ...
                    <?php else: ?>
                        <a href="goal.php" class="btn btn-info btn-lg text-white">目標一覧に戻る</a>
                    <?php endif; ?>
