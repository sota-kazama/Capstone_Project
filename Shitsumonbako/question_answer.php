                ...
                <div class="card mt-4">
                    <div class="card-body">
                        ...
                        <p class="text-muted mt-3">
                            投稿日：<?php
                        if (!empty($q->update_at)) { echo date("Y-m-d H:i:s", strtotime($q->update_at)); } elseif
                            (!empty($q->asked_date)) { echo date("Y-m-d H:i:s", strtotime($q->asked_date)); } else {
                            echo '不明'; } ?>
                        </p>
                    </div>
                </div>
                    ...
                    <div class="card mb-2">
                        <div class="card-body">
                            ...
                            <small class="text-muted">
                                投稿日:
                                <?= !empty($a->update_at) ? date("Y-m-d H:i:s", strtotime($a->update_at)) :
                                ($a->answer_date ?? '不明') ?>
                            </small>
                        </div>
                    </div>
