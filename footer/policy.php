...
<html lang="jp">
    <head>
        ...
        <?php include __DIR__ . '/../template/hamburger.html'; ?>
    ...
    <body>
        ...
        <p>
            プライバシーポリシー（個人情報保護方針）
            株式会社○○（以下、「当社」という。）は，ユーザーの個人情報について以下のとおりプライバシーポリシー（以下、「本ポリシー」という。）を定めます。本ポリシーは、当社がどのような個人情報を取得し、どのように利用・共有するか、ユーザーがどのようにご自身の個人情報を管理できるかをご説明するものです。<br />
            【１．事業者情報】 法人名：株式会社○○ 住所：○○<br />
            代表者：○○【２．個人情報の取得方法】
            ...
            【５．個人データの共同利用】 当社は、以下のとおり共同利用を行います。 個人データの管理に関する責任者
            株式会社○○ 共同して利用する者の利用目的 上記「利用目的」の内容と同様。 利用項目
            氏名、住所、電話番号、メールアドレス 共同して利用する者の範囲 当社企業グループを構成する企業<br />
            【６．個人データの第三者提供について】
            ...
            （各社請求方法を指定） 送付先住所 〒○○ 東京都○○ 株式会社○○　お問い合わせ窓口<br />
            ...
            お使いのWebブラウザの設定により、cookieを無効にすることも可能です。<br />

            【１１．プライバシーポリシーの制定日及び改定日】 制定：○○年○月○日 改定：○○年○月○日 改定：○○年○月○日<br />
